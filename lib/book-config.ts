export const chapters = [
  ...
  { number: 4, title: "Freelance Services", path: "/freelance", label: "Freelance", bookmarkColor: "#E85050" },
  { number: 5, title: "Journal", path: "/blog", label: "Blog", bookmarkColor: "#48B8D0" },
  { number: 6, title: "Get in Touch", path: "/contact", label: "Contact", bookmarkColor: "#F0D840" },
];
